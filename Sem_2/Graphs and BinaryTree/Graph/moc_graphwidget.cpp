...
QT_MOC_LITERAL(1, 12, 13), // "vertexClicked"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 1), // "v"
QT_MOC_LITERAL(4, 29, 11), // "vertexMoved"
QT_MOC_LITERAL(5, 41, 6) // "newPos"

    },
    "GraphWidget\0vertexClicked\0\0v\0vertexMoved\0"
    "newPos"
};
...
void GraphWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphWidget::vertexClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GraphWidget::*)(int , const QPoint & );
...
// SIGNAL 1
void GraphWidget::vertexMoved(int _t1, const QPoint & _t2)
{
