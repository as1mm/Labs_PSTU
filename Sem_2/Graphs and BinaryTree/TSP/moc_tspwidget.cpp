...
QT_MOC_LITERAL(1, 10, 13), // "vertexClicked"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 1), // "v"
QT_MOC_LITERAL(4, 27, 11), // "vertexMoved"
QT_MOC_LITERAL(5, 39, 6) // "newPos"

    },
    "TSPWidget\0vertexClicked\0\0v\0vertexMoved\0"
    "newPos"
};
...
void TSPWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TSPWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->vertexClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->vertexMoved((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QPoint(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TSPWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TSPWidget::vertexClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TSPWidget::*)(int , const QPoint & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TSPWidget::vertexMoved)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TSPWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_TSPWidget.data,
    qt_meta_data_TSPWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void TSPWidget::vertexClicked(int _t1)
{
...
// SIGNAL 1
void TSPWidget::vertexMoved(int _t1, const QPoint & _t2)
{
